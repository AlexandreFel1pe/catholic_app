      ...
      body: ExpansionCardList(
        children: [
          ...
          ExpansionCard(
            ...
            content: '',
            isInitialyExpanded: isMisteryDay([Dias.segunda, Dias.sabado]),
            autoCollapse: false,
            expansionCardList: ExpansionCardList(
              children: [
                ExpansionCard(title: '1º Mistério Contemplamos', content: 'A Anunciação do Anjo e a Encarnação do Verbo', isInitialyExpanded: true),
                ExpansionCard(title: '2º Mistério Contemplamos', content: 'A visitação de Maria a sua prima Santa Isabel'),
                ExpansionCard(title: '3º Mistério Contemplamos', content: 'Nascimento do Menino Jesus, na gruta fria em Belém'),
                ExpansionCard(title: '4º Mistério Contemplamos', content: 'A apresentação do Menino Jesus no templo, e a purificação de Maria'),
                ExpansionCard(title: '5º Mistério Contemplamos', content: 'A perda e o encontro do Menino Jesus no templo'),
              ],
            ),
          ),
          ExpansionCard(
            ...
            content: '',
            isInitialyExpanded: isMisteryDay([Dias.quinta]),
            autoCollapse: false,
            expansionCardList: ExpansionCardList(
              children: [
                ExpansionCard(title: '1º Mistério Contemplamos', content: 'Batismo de Nosso Senhor Jesus Cristo no rio Jordão', isInitialyExpanded: true),
                ExpansionCard(title: '2º Mistério Contemplamos', content: 'Primeiro milagre de Jesus transformando a água em vinho nas bodas de Caaná'),
                ExpansionCard(title: '3º Mistério Contemplamos', content: 'Anunciação do Reino de Deus e o convite à conversãontent'),
                ExpansionCard(title: '4º Mistério Contemplamos', content: 'A transfiguração de Nosso Senhor no Monte Thabor'),
                ExpansionCard(title: '5º Mistério Contemplamos', content: 'A Instituição da Eucaristia na Última Ceia'),
              ],
            ),
          ),
          ExpansionCard(
            ...
            content: '',
            isInitialyExpanded: isMisteryDay([Dias.terca, Dias.sexta]),
            autoCollapse: false,
            expansionCardList: ExpansionCardList(
              children: [
                ExpansionCard(title: '1º Mistério Contemplamos', content: 'A oração e agonia no Horto das Oliveira', isInitialyExpanded: true),
                ExpansionCard(title: '2º Mistério Contemplamos', content: 'Flagelação de Nosso Senhor Jesus Cristo'),
                ExpansionCard(title: '3º Mistério Contemplamos', content: 'A coroação de espinhos de Nosso Senhor Jesus Cristo'),
                ExpansionCard(title: '4º Mistério Contemplamos', content: 'Nosso Senhor carregando a Cruz às costas'),
                ExpansionCard(title: '5º Mistério Contemplamos', content: 'A Crucifixão e morte de Nosso Senhor Jesus Cristo'),
              ],
            ),
          ),
          ExpansionCard(
            ...
            content: '',
            isInitialyExpanded: isMisteryDay([Dias.quarta, Dias.domingo]),
            autoCollapse: false,
            expansionCardList: ExpansionCardList(
              children: [
                ExpansionCard(title: '1º Mistério Contemplamos', content: 'A Ressurreição de Nosso Senhor Jesus Cristo', isInitialyExpanded: true),
                ExpansionCard(title: '2º Mistério Contemplamos', content: 'A Ascensão de Nosso Senhor Jesus Cristo'),
                ExpansionCard(title: '3º Mistério Contemplamos', content: 'A descida do Espírito Santo'),
                ExpansionCard(title: '4º Mistério Contemplamos', content: 'A Assunção de Nossa Senhora aos Céus de corpo e alma'),
                ExpansionCard(title: '5º Mistério Contemplamos', content: 'A Coroação de Nossa Senhora como Rainha do Céu  e da Terra dos Anjos e dos Homens'),
              ],
            ),
          ),
          ExpansionCard(
